...
base = 'C:\\Users\\gdaabul\\OneDrive - Intel Corporation\\Desktop\\opencv\\Face-Detection-master'

# load SSD and ResNet network based caffe model for 300x300 dim imgs
net = cv2.dnn.readNetFromCaffe(base + "\\weights-prototxt.txt", base +  "\\res_ssd_300Dim.caffeModel")
